...
/*   Updated: 2026/03/12 11:16:02 by tseche           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//--------------------[EXPAND_DISPATCH.c]-------------
char	**dispatch_expand(char **args, t_data *shell,
			char **arg, int nbr_files);
void	dequote_range(char **args, int start, int end);
...
//--------------------[WILDCARD]----------------
int		wildcard(char **args, int k, char **tmp, int nbr_files);
